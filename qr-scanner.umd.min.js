(function (global, factory) {
    ...
    class QrScanner {
        ...
        static createQrEngine(workerPath) {
            ...
            return new Worker(new URL("./qr-scanner-worker.min.js", (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.src || new URL('qr-scanner.umd.min.js', document.baseURI).href))), {
                type: "module",
            });
        }
        _onPlay() {
