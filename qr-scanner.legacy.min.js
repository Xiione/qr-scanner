(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('jsqr-es6'), require('jsqr-es6/dist/decoder/reedsolomon')) :
    typeof define === 'function' && define.amd ? define(['jsqr-es6', 'jsqr-es6/dist/decoder/reedsolomon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.QrScanner = factory(global.jsQR, global.reedsolomon));
})(this, (function (jsQR, reedsolomon) { 'use strict';
    ...
    function decode(data, requestId) {
        ...
        const result = jsQR__default.default(rgbaData, width, height, {
    ...
    class QrScanner {
        ...
        setGrayscaleWeights(red, green, blue, useIntegerApproximation = true) {
            ...
            QrScanner._postWorkerMessage(this._qrEngine, 'grayscaleWeights', { red, green, blue, useIntegerApproximation });
        }
