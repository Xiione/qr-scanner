(function (global, factory) {
    ...
    class QrScanner {
        ...
        static createQrEngine(workerPath) {
            ...
            return new Worker(new URL('./qr-scanner-worker.min.js', (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('qr-scanner.legacy.min.js', document.baseURI).href))), {
                type: 'module'
            });
        }
        _onPlay() {
