(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('jsqr-es6'), require('jsqr-es6/dist/BitMatrix'), require('jsqr-es6/dist/decoder/reedsolomon')) :
    typeof define === 'function' && define.amd ? define(['jsqr-es6', 'jsqr-es6/dist/BitMatrix', 'jsqr-es6/dist/decoder/reedsolomon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.QrScanner = factory(global.jsQR, global.BitMatrix, global.reedsolomon));
})(this, (function (jsQR, BitMatrix, reedsolomon) { 'use strict';
        ...
        static async scanImage(imageOrFileOrBlobOrUrl, scanRegionOrOptions, qrEngine, canvas, disallowCanvasResizing = false, alsoTryWithoutScanRegion = false) {
            ...
            try {
                ...
                if (qrEngine) {
                        ...
                        onMessage = (event) => {
                            ...
                            if (event.data.data !== null) {
                                ...
                                const res = {
                                    ...
                                    matrix: BitMatrix.BitMatrix.createFromPacked(data.matrixData, data.matrixWidth, data.matrixWidth),
                                    matrixCorrected: BitMatrix.BitMatrix.createFromPacked(data.matrixDataCorrected, data.matrixWidth, data.matrixWidth),
                    ...
                    if (!reedsolomon.getDecoderInitialized()) {
                        await reedsolomon.initDecoder();
                    }
