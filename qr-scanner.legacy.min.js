(function (global, factory) {
    ...
    class QrScanner {
        ...
        destroy() {
            ...
            console.log("at destroy time: ", this._qrEngine);
        ...
        static createQrEngine(workerPath) {
            console.log("create engine", workerPath);
            if (workerPath) {
                console.warn('Specifying a worker path is not required and not supported anymore.');
            }
            const worker = new Worker(new URL('./qr-scanner-worker.min.js', (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('qr-scanner.legacy.min.js', document.baseURI).href))), {
                type: 'module'
            });
            console.log("worker after construction", worker);
            return worker;
        }
        _onPlay() {
