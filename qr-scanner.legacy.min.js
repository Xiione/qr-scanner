(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.QrScanner = factory());
})(this, (function () { 'use strict';

  var rsiscool = (() => {
    var _scriptName = (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('qr-scanner.legacy.min.js', document.baseURI).href));
...
k.name).join(", ")}) => ${d.name}>`;return Mb(T(c,a))},I:a=>{a=Kb(a);return U(n[a])},m:(a,b)=>{a=Y(a);b=Y(b);return U(a[b])},h:a=>{9<a&&(X[a+1]+=1);},q:a=>U(Kb(a)),e:a=>{var b=Y(a);Fa(b);ub(a);},n:(a,b)=>{a=Gb(a,"_emval_take_value");a=a.readValueFromPointer(b);return U(a)},w:()=>{ta("OOM");},u:(a,b)=>{var c=0;Qb().forEach((d,e)=>{var h=b+c;e=D[a+4*e>>2]=h;for(h=0;h<d.length;++h)y[e++]=d.charCodeAt(h);y[e]=0;c+=d.length+1;});return 0},v:(a,b)=>{var c=Qb();D[a>>2]=c.length;var d=0;c.forEach(e=>d+=e.length+
  ...
  if(n.instantiateWasm)try{return n.instantiateWasm(b,a)}catch(c){v(`Module.instantiateWasm callback failed with error: ${c}`),da(c);}va||=n.locateFile?ua("rsiscool.wasm")?"rsiscool.wasm":n.locateFile?n.locateFile("rsiscool.wasm",p):p+"rsiscool.wasm":(new URL("rsiscool.wasm",(typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('qr-scanner.legacy.min.js', document.baseURI).href)))).href;za(b,function(c){a(c.instance);}).catch(da);return {}}(),kb=a=>(kb=Z.L)(a),Tb=a=>(Tb=Z.N)(a),W=a=>(W=Z.O)(a),Vb;F=function Wb(){Vb||Xb();Vb||(F=Wb);};
  ...
  class QrScanner {
      ...
      static async createQrEngine(workerPath) {
          ...
          const createWorker = () => Promise.resolve().then(function () { return qrScannerWorker_min; })
  ...
  const createWorker=()=>new Worker(URL.createObjectURL(new Blob([`function decodeWASM(bytes, twoS) {
    {
