...
import { getDecoderInitialized, initDecoder } from 'jsqr-es6/dist/decoder/reedsolomon/index.js';
                    ...
                    onMessage = (event) => {
                        ...
                        if (event.data.data !== null) {
                            ...
                            const res = {
                                ...
                                matrix: BitMatrix.createFromPacked(data.matrixData, data.matrixWidth, data.matrixWidth),
                                matrixCorrected: BitMatrix.createFromPacked(data.matrixDataCorrected, data.matrixWidth, data.matrixWidth),
